...
///////////////////////////////////////////////////////////
  ...
  var drawLine = function(gesture, width, height, lineWidth) {
    ...
    var curve = function(dir) {
      prev = curr;
      ctx.lineTo(prev.x, prev.y);
      if     (dir == "UD") { curr = {x:prev.x, y:prev.y-step}; minmax();
      ...
      else if(dir == "DU") { curr = {x:prev.x, y:prev.y+step}; minmax();
                             ctx.lineTo(prev.x, prev.y+step);
      ...
      else if(dir == "LR") { curr = {x:prev.x-step, y:prev.y}; minmax();
      ...
      else if(dir == "RL") { curr = {x:prev.x+step, y:prev.y}; minmax();
                             ctx.lineTo(prev.x+step, prev.y);
